...
write.table(results_df, 
            "Pearson_Correlation_mean_rho_vs_distance-to-Cla_run12_less500bp.txt", sep = ";")
...
library(cowplot)
save_plot("~/sciebo/RecombinationLandscape_CRIP/01_Revison/NewResults/Plots/heatmap_run12_less500bp.png", p, nrow = 1, ncol = 2, base_asp = 3.8, dpi = 500, bg = "white")

save_plot("~/sciebo/RecombinationLandscape_CRIP/01_Revison/NewResults/Plots/heatmap_run12_less500bp.svg", p, nrow = 1, ncol = 2, base_asp = 3.8, dpi = 500, bg = "white")
...
save_plot("~/sciebo/RecombinationLandscape_CRIP/01_Revison/NewResults/Plots/heatmap_run12_les500bp_noNAarm.png", p, nrow = 1.8, ncol = 2, base_asp = 3.8, dpi = 500, bg = "white")

save_plot("~/sciebo/RecombinationLandscape_CRIP/01_Revison/NewResults/Plots/heatmap_run12_less500bp_noNAarm.svg", p, nrow = 3, ncol = 3, base_asp = 3.8, dpi = 500, bg = "white")
