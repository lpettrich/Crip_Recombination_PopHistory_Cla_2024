...
c1.1_blankx <- c1.1 + scale_y_continuous(n.breaks = 5, limits=c(0, 160)) +
...
c2.1_blankxy <- c2.1 + scale_y_continuous(n.breaks = 5, limits=c(0, 160)) +
...
c3.1_blankxy <- c3.1 + scale_y_continuous(n.breaks = 5, limits=c(0, 160)) +
...
c1.2_noblank <- c1.2 + scale_y_continuous(n.breaks = 5, limits=c(0, 160)) +
  labs(title = "Chromosome 1, arm 2") +
  annotate("text", x = Inf, y = Inf, 
           label = paste("n =", sum(dfm$chromosome_arm == "Chr1_arm2")), 
           hjust = 1.1, vjust = 1.5, size = 5, color = "black")


c2.2_blanky <- c2.2 + scale_y_continuous(n.breaks = 5, limits=c(0, 160)) +
  theme_blanky + labs(title = "Chromosome 2, arm 2") +
  annotate("text", x = Inf, y = Inf, 
           label = paste("n =", sum(dfm$chromosome_arm == "Chr2_arm2")), 
           hjust = 1.1, vjust = 1.5, size = 5, color = "black")


c3.2_blanky <- c3.2 + scale_y_continuous(n.breaks = 5, limits=c(0, 160)) +
...
p_merged <- c1.1_blankx + c2.1_blankxy + c3.1_blankxy + 
  ...
  patchwork::plot_layout(ncol = 3, heights = c(1,1))

p_merged

save_plot("~/sciebo/RecombinationLandscape_CRIP/01_Revison/NewResults/Plots/DecayPlots_run12_arms_100kb_all_less500bp.png", p_merged, nrow = 2, ncol = 3, base_asp = 1.9, dpi = 500, bg = "white")
save_plot("~/sciebo/RecombinationLandscape_CRIP/01_Revison/NewResults/Plots/DecayPlots_run12_arms_10kb_all_less500bp.svg", p_merged, nrow = 2, ncol = 3, base_asp = 1.9, dpi = 500, bg = "white")
