...
# Read data
df1 <- read.table("Pearson_Correlation_mean_rho_vs_distance-to-Cla_run12_less500bp.txt", sep = ";")
df2 <- read.table("Pearson_Correlation_mean_rho_vs_distance-to-Cla_run12_more500bp.txt", sep = ";")
...
save_plot("~/sciebo/RecombinationLandscape_CRIP/01_Revison/NewResults/Plots/heatmap_run12.png", p, nrow = 3, ncol = 2, base_asp = 1.2, dpi = 500, bg = "white")

save_plot("~/sciebo/RecombinationLandscape_CRIP/01_Revison/NewResults/Plots/heatmap_run12.svg", p, nrow = 3, ncol = 2, base_asp = 1.2, dpi = 500, bg = "white")
...
save_plot("~/sciebo/RecombinationLandscape_CRIP/01_Revison/NewResults/Plots/heatmap_run12_noNAarm.png", p, nrow = 2, ncol = 2, base_asp = 1.2, dpi = 500, bg = "white")

save_plot("~/sciebo/RecombinationLandscape_CRIP/01_Revison/NewResults/Plots/heatmap_run12_noNAarm.svg", p, nrow = 2, ncol = 2, base_asp = 1.2, dpi = 500, bg = "white")
