...
save_plot("~/sciebo/RecombinationLandscape_CRIP/01_Revison/NewResults/Plots/DecayPlots_run12_arms_100kb_all_more500bp.png", p_merged, nrow = 2, ncol = 3, base_asp = 1.9, dpi = 500, bg = "white")
save_plot("~/sciebo/RecombinationLandscape_CRIP/01_Revison/NewResults/Plots/DecayPlots_run12_arms_10kb_all_more500bp.svg", p_merged, nrow = 2, ncol = 3, base_asp = 1.9, dpi = 500, bg = "white")
