...
# Read in bedtools closest results (100kb)
...
df1 <- read.csv("bedtools_closest_ouput_100kb_arms_MF_20241003.csv", sep = ",", header = TRUE)
df2 <- read.csv("bedtools_closest_ouput_100kb_arms_MG_20241003.csv", sep = ",", header = TRUE)
df3 <- read.csv("bedtools_closest_ouput_100kb_arms_NMF_20241003.csv", sep = ",", header = TRUE)
df4 <- read.csv("bedtools_closest_ouput_100kb_arms_SI_20241003.csv", sep = ",", header = TRUE)
df5 <- read.csv("bedtools_closest_ouput_100kb_arms_SS_20241003.csv", sep = ",", header = TRUE)
...
# define max size
max_dist <- max(dfm$dist_to_Cla[dfm$chromosome_arm == "Chr1_arm1"])
...
for (group_value in c("Chr1_arm1")) {
...
# define max size
max_dist <- max(dfm$dist_to_Cla[dfm$chromosome_arm == "Chr1_arm2"])
...
for (group_value in c("Chr1_arm2")) {
...
# Plot using ggplot2
c1.2 <- ggplot(plot_data, aes(x = x, y = y)) +
geom_ribbon(aes(ymin = ymin, ymax = ymax), fill = "#c8c8c8") +
geom_line(linewidth = 1) +
ylim(scale * c(ymin, ymax)) +
#xlim(0, 7e6/100e3) +
...
# define max size
max_dist <- max(dfm$dist_to_Cla[dfm$chromosome_arm == "Chr2_arm1"])
...
for (group_value in c("Chr2_arm1")) {
...
# define max size
max_dist <- max(dfm$dist_to_Cla[dfm$chromosome_arm == "Chr2_arm2"])
...
# Calculate mean rho per distance bin
  ...
  for (group_value in c("Chr2_arm2")) {
...
# Plot using ggplot2
c2.2 <- ggplot(plot_data, aes(x = x, y = y)) +
  geom_ribbon(aes(ymin = ymin, ymax = ymax), fill = "#c8c8c8") +
  geom_line(linewidth = 1) +
  ylim(scale * c(ymin, ymax)) +
  #xlim(0, 7e6/100e3) +
...
# define max size
max_dist <- max(dfm$dist_to_Cla[dfm$chromosome_arm == "Chr3_arm1"])
...
for (group_value in c("Chr3_arm1")) {
...
ribbon_col="#c8c8c8"
  ...
  # define max size
  max_dist <- max(dfm$dist_to_Cla[dfm$chromosome_arm == "Chr3_arm2"])
  ...
  for (group_value in c("Chr3_arm2")) {
  ...
  ribbon_col="#c8c8c8"
    ...
    # Plot using ggplot2
    c3.2 <- ggplot(plot_data, aes(x = x, y = y)) +
      geom_ribbon(aes(ymin = ymin, ymax = ymax), fill = "#c8c8c8") +
      geom_line(linewidth = 1) +
      ylim(scale * c(ymin, ymax)) +
      #xlim(0, 7e6/100e3) +
...
c1.1_blankx <- c1.1 + scale_y_continuous(n.breaks = 5, limits=c(-10, 200)) +
...
c2.1_blankx <- c2.1 + scale_y_continuous(n.breaks = 5, limits=c(-10, 200)) +
  theme_blankx + labs(title = "Chromosome 2, arm 1") +
  annotate("text", x = Inf, y = Inf, 
           label = paste("n =", sum(dfm$chromosome_arm == "Chr2_arm1")), 
           hjust = 1.1, vjust = 1.5, size = 5, color = "black")


c3.1_noblank <- c3.1 + scale_y_continuous(n.breaks = 5, limits=c(-10, 200)) +
  labs(title = "Chromosome 3, arm 1") +
  annotate("text", x = Inf, y = Inf, 
           label = paste("n =", sum(dfm$chromosome_arm == "Chr3_arm1")), 
           hjust = 1.1, vjust = 1.5, size = 5, color = "black")


c1.2_blankxy <- c1.2 + scale_y_continuous(n.breaks = 5, limits=c(-10, 200)) +
  theme_blankxy + labs(title = "Chromosome 1, arm 2") +
  annotate("text", x = Inf, y = Inf, 
           label = paste("n =", sum(dfm$chromosome_arm == "Chr1_arm2")), 
           hjust = 1.1, vjust = 1.5, size = 5, color = "black")


c2.2_blankxy <- c2.2 + scale_y_continuous(n.breaks = 5, limits=c(-10, 200)) +
  theme_blankxy + labs(title = "Chromosome 2, arm 2") +
  annotate("text", x = Inf, y = Inf, 
           label = paste("n =", sum(dfm$chromosome_arm == "Chr2_arm2")), 
           hjust = 1.1, vjust = 1.5, size = 5, color = "black")


c3.2_blanky <- c3.2 + scale_y_continuous(n.breaks = 5, limits=c(-10, 200)) +
  theme_blanky + labs(title = "Chromosome 3, arm 2") +
  annotate("text", x = Inf, y = Inf, 
           label = paste("n =", sum(dfm$chromosome_arm == "Chr3_arm2")), 
           hjust = 1.1, vjust = 1.5, size = 5, color = "black")



p_merged <- c1.1_blankx + c1.2_blankxy +
  c2.1_blankx + c2.2_blankxy + 
  c3.1_noblank + c3.2_blanky +
  patchwork::plot_layout(ncol = 2, nrow = 3, heights = c(1,1))

p_merged

save_plot("~/sciebo/RecombinationLandscape_CRIP/01_Revison/NewResults/Plots/DecayPlots_run12_arms_100kb_all_less500bp.png", p_merged, nrow = 3, ncol = 2, base_asp = 1.9, dpi = 500, bg = "white")
save_plot("~/sciebo/RecombinationLandscape_CRIP/01_Revison/NewResults/Plots/DecayPlots_run12_arms_100kb_all_less500bp.svg", p_merged, nrow = 3, ncol = 2, base_asp = 1.9, dpi = 500, bg = "white")
...
save_plot("~/sciebo/RecombinationLandscape_CRIP/01_Revison/NewResults/Plots/DecayPlots_run12_arms_100kb_chr4_all_less500bp.png", c4, base_asp = 1.9, dpi = 500, bg = "white")
save_plot("~/sciebo/RecombinationLandscape_CRIP/01_Revison/NewResults/Plots/DecayPlots_run12_arms_100kb_chr4_all_less500bp.svg", c4, base_asp = 1.9, dpi = 500, bg = "white")


# chr1.1
c1.1_n <- c1.1 + scale_y_continuous(n.breaks = 5, limits=c(-10, 200)) + 
  #labs(title = "Chromosome 4") +
  annotate("text", x = Inf, y = Inf, 
           label = paste("n =", sum(dfm$chromosome_arm == "Chr1_arm1")), 
           hjust = 1.1, vjust = 1.5, size = 5, color = "black")
...
save_plot("~/sciebo/RecombinationLandscape_CRIP/01_Revison/NewResults/Plots/DecayPlots_run12_arms_100kb_chr1.1_all_less500bp.png", c1.1_n, base_asp = 1.9, dpi = 500, bg = "white")
save_plot("~/sciebo/RecombinationLandscape_CRIP/01_Revison/NewResults/Plots/DecayPlots_run12_arms_100kb_chr1.1_all_less500bp.svg", c1.1_n, base_asp = 1.9, dpi = 500, bg = "white")

# chr1.2
c1.2_n <- c1.2 + scale_y_continuous(n.breaks = 5, limits=c(-10, 200)) + 
  #labs(title = "Chromosome 4") +
  annotate("text", x = Inf, y = Inf, 
           label = paste("n =", sum(dfm$chromosome_arm == "Chr1_arm2")), 
           hjust = 1.1, vjust = 1.5, size = 5, color = "black")
...
save_plot("~/sciebo/RecombinationLandscape_CRIP/01_Revison/NewResults/Plots/DecayPlots_run12_arms_100kb_chr1.2_all_less500bp.png", c1.2_n, base_asp = 1.9, dpi = 500, bg = "white")
save_plot("~/sciebo/RecombinationLandscape_CRIP/01_Revison/NewResults/Plots/DecayPlots_run12_arms_100kb_chr1.2_all_less500bp.svg", c1.2_n, base_asp = 1.9, dpi = 500, bg = "white")

# chr2.1
c2.1_n <- c2.1 + scale_y_continuous(n.breaks = 5, limits=c(-10, 200)) + 
  #labs(title = "Chromosome 4") +
  annotate("text", x = Inf, y = Inf, 
           label = paste("n =", sum(dfm$chromosome_arm == "Chr2_arm1")), 
           hjust = 1.1, vjust = 1.5, size = 5, color = "black")
...
save_plot("~/sciebo/RecombinationLandscape_CRIP/01_Revison/NewResults/Plots/DecayPlots_run12_arms_100kb_chr2.1_all_less500bp.png", c2.1_n, base_asp = 1.9, dpi = 500, bg = "white")
save_plot("~/sciebo/RecombinationLandscape_CRIP/01_Revison/NewResults/Plots/DecayPlots_run12_arms_100kb_chr2.1_all_less500bp.svg", c2.1_n, base_asp = 1.9, dpi = 500, bg = "white")

# chr2.2
c2.2_n <- c2.2 + scale_y_continuous(n.breaks = 5, limits=c(-10, 200)) + 
  #labs(title = "Chromosome 4") +
  annotate("text", x = Inf, y = Inf, 
           label = paste("n =", sum(dfm$chromosome_arm == "Chr2_arm2")), 
           hjust = 1.1, vjust = 1.5, size = 5, color = "black")
...
save_plot("~/sciebo/RecombinationLandscape_CRIP/01_Revison/NewResults/Plots/DecayPlots_run12_arms_100kb_chr2.2_all_less500bp.png", c2.2_n, base_asp = 1.9, dpi = 500, bg = "white")
save_plot("~/sciebo/RecombinationLandscape_CRIP/01_Revison/NewResults/Plots/DecayPlots_run12_arms_100kb_chr2.2_all_less500bp.svg", c2.2_n, base_asp = 1.9, dpi = 500, bg = "white")

# chr3.1
c3.1_n <- c3.1 + scale_y_continuous(n.breaks = 5, limits=c(-10, 200)) + 
  #labs(title = "Chromosome 4") +
  annotate("text", x = Inf, y = Inf, 
           label = paste("n =", sum(dfm$chromosome_arm == "Chr3_arm1")), 
           hjust = 1.1, vjust = 1.5, size = 5, color = "black")
...
save_plot("~/sciebo/RecombinationLandscape_CRIP/01_Revison/NewResults/Plots/DecayPlots_run12_arms_100kb_chr3.1_all_less500bp.png", c3.1_n, base_asp = 1.9, dpi = 500, bg = "white")
save_plot("~/sciebo/RecombinationLandscape_CRIP/01_Revison/NewResults/Plots/DecayPlots_run12_arms_100kb_chr3.1_all_less500bp.svg", c3.1_n, base_asp = 1.9, dpi = 500, bg = "white")

# chr3.2
c3.2_n <- c3.2 + scale_y_continuous(n.breaks = 5, limits=c(-10, 200)) + 
  #labs(title = "Chromosome 4") +
  annotate("text", x = Inf, y = Inf, 
           label = paste("n =", sum(dfm$chromosome_arm == "Chr3_arm2")), 
           hjust = 1.1, vjust = 1.5, size = 5, color = "black")
...
save_plot("~/sciebo/RecombinationLandscape_CRIP/01_Revison/NewResults/Plots/DecayPlots_run12_arms_100kb_chr3.2_all_less500bp.png", c3.2_n, base_asp = 1.9, dpi = 500, bg = "white")
save_plot("~/sciebo/RecombinationLandscape_CRIP/01_Revison/NewResults/Plots/DecayPlots_run12_arms_100kb_chr3.2_all_less500bp.svg", c3.2_n, base_asp = 1.9, dpi = 500, bg = "white")
