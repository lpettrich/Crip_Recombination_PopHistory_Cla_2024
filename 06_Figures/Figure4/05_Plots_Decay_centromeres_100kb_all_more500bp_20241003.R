...
c1.1_blankx <- c1.1 + scale_y_continuous(n.breaks = 5, limits=c(0, 40)) +
...
c2.1_blankxy <- c2.1 + scale_y_continuous(n.breaks = 5, limits=c(0, 40)) +
...
c3.1_blankxy <- c3.1 + scale_y_continuous(n.breaks = 5, limits=c(0, 40)) +
...
save_plot("~/sciebo/RecombinationLandscape_CRIP/01_Revison/NewResults/Plots/DecayPlots_run12_centromeres_100kb_all_more500bp_20241003.png", p_merged, nrow = 2, ncol = 3, base_asp = 1.9, dpi = 500, bg = "white")
save_plot("~/sciebo/RecombinationLandscape_CRIP/01_Revison/NewResults/Plots/DecayPlots_run12_centromeres_100kb_all_more500bp_20241003.svg", p_merged, nrow = 2, ncol = 3, base_asp = 1.9, dpi = 500, bg = "white")
...
save_plot("~/sciebo/RecombinationLandscape_CRIP/01_Revison/NewResults/Plots/DecayPlots_run12_centromeres_100kb_chr1.1_all_more500bp_20241003.png", c1.1_n, base_asp = 1.9, dpi = 500, bg = "white")
save_plot("~/sciebo/RecombinationLandscape_CRIP/01_Revison/NewResults/Plots/DecayPlots_run12_centromeres_100kb_chr1.1_all_more500bp_20241003.svg", c1.1_n, base_asp = 1.9, dpi = 500, bg = "white")
...
save_plot("~/sciebo/RecombinationLandscape_CRIP/01_Revison/NewResults/Plots/DecayPlots_run12_centromeres_100kb_chr2.1_all_more500bp_20241003.png", c2.1_n, base_asp = 1.9, dpi = 500, bg = "white")
save_plot("~/sciebo/RecombinationLandscape_CRIP/01_Revison/NewResults/Plots/DecayPlots_run12_centromeres_100kb_chr2.1_all_more500bp_20241003.svg", c2.1_n, base_asp = 1.9, dpi = 500, bg = "white")
...
save_plot("~/sciebo/RecombinationLandscape_CRIP/01_Revison/NewResults/Plots/DecayPlots_run12_centromeres_100kb_chr3.1_all_more500bp_20241003.png", c3.1_n, base_asp = 1.9, dpi = 500, bg = "white")
save_plot("~/sciebo/RecombinationLandscape_CRIP/01_Revison/NewResults/Plots/DecayPlots_run12_centromeres_100kb_chr3.1_all_more500bp_20241003.svg", c3.1_n, base_asp = 1.9, dpi = 500, bg = "white")
