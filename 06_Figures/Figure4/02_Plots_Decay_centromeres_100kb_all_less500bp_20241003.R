...
# define max size
max_dist <- max(dfm$dist_to_Cla[dfm$chromosome_arm == "Chr1_centromere"])
...
for (group_value in c("Chr1_centromere")) {
...
# define max size
max_dist <- max(dfm$dist_to_Cla[dfm$chromosome_arm == "Chr2_centromere"])
...
for (group_value in c("Chr2_centromere")) {
...
# define max size
max_dist <- max(dfm$dist_to_Cla[dfm$chromosome_arm == "Chr3_centromere"])
...
for (group_value in c("Chr3_centromere")) {
...
c1.1_blankx <- c1.1 + scale_y_continuous(n.breaks = 5, limits=c(0, 100)) +
  theme_blankx + labs(title = "Chromosome 1, centromere") +
  annotate("text", x = Inf, y = Inf, 
           label = paste("n =", sum(dfm$chromosome_arm == "Chr1_centromere")), 
           hjust = 1.1, vjust = 1.5, size = 5, color = "black")


c2.1_blankxy <- c2.1 + scale_y_continuous(n.breaks = 5, limits=c(0, 100)) +
  theme_blankxy + labs(title = "Chromosome 2, centromere") +
  annotate("text", x = Inf, y = Inf, 
           label = paste("n =", sum(dfm$chromosome_arm == "Chr2_centromere")), 
           hjust = 1.1, vjust = 1.5, size = 5, color = "black")


c3.1_blankxy <- c3.1 + scale_y_continuous(n.breaks = 5, limits=c(0, 100)) +
  theme_blankxy + labs(title = "Chromosome 3, centromere") +
  annotate("text", x = Inf, y = Inf, 
           label = paste("n =", sum(dfm$chromosome_arm == "Chr3_centromere")), 
           hjust = 1.1, vjust = 1.5, size = 5, color = "black")
...
save_plot("~/sciebo/RecombinationLandscape_CRIP/01_Revison/NewResults/Plots/DecayPlots_run12_centromeres_100kb_all_less500bp_20241003.png", p_merged, nrow = 2, ncol = 3, base_asp = 1.9, dpi = 500, bg = "white")
save_plot("~/sciebo/RecombinationLandscape_CRIP/01_Revison/NewResults/Plots/DecayPlots_run12_centromeres_100kb_all_less500bp_20241003.svg", p_merged, nrow = 2, ncol = 3, base_asp = 1.9, dpi = 500, bg = "white")
...
# chr1.1
c1.1_n <- c1.1 + scale_y_continuous(n.breaks = 5, limits=c(-10, 100)) + 
  #labs(title = "Chromosome 4") +
  annotate("text", x = Inf, y = Inf, 
           label = paste("n =", sum(dfm$chromosome_arm == "Chr1_centromere")), 
           hjust = 1.1, vjust = 1.5, size = 5, color = "black")
...
save_plot("~/sciebo/RecombinationLandscape_CRIP/01_Revison/NewResults/Plots/DecayPlots_run12_centromeres_100kb_chr1.1_all_less500bp_20241003.png", c1.1_n, base_asp = 1.9, dpi = 500, bg = "white")
save_plot("~/sciebo/RecombinationLandscape_CRIP/01_Revison/NewResults/Plots/DecayPlots_run12_centromeres_100kb_chr1.1_all_less500bp_20241003.svg", c1.1_n, base_asp = 1.9, dpi = 500, bg = "white")


# chr2.1
c2.1_n <- c2.1 + scale_y_continuous(n.breaks = 5, limits=c(-10, 100)) + 
  #labs(title = "Chromosome 4") +
  annotate("text", x = Inf, y = Inf, 
           label = paste("n =", sum(dfm$chromosome_arm == "Chr2_centromere")), 
           hjust = 1.1, vjust = 1.5, size = 5, color = "black")
...
save_plot("~/sciebo/RecombinationLandscape_CRIP/01_Revison/NewResults/Plots/DecayPlots_run12_centromeres_100kb_chr2.1_all_less500bp_20241003.png", c2.1_n, base_asp = 1.9, dpi = 500, bg = "white")
save_plot("~/sciebo/RecombinationLandscape_CRIP/01_Revison/NewResults/Plots/DecayPlots_run12_centromeres_100kb_chr2.1_all_less500bp_20241003.svg", c2.1_n, base_asp = 1.9, dpi = 500, bg = "white")


# chr3.1
c3.1_n <- c3.1 + scale_y_continuous(n.breaks = 5, limits=c(-10, 100)) + 
  #labs(title = "Chromosome 4") +
  annotate("text", x = Inf, y = Inf, 
           label = paste("n =", sum(dfm$chromosome_arm == "Chr3_centromere")), 
           hjust = 1.1, vjust = 1.5, size = 5, color = "black")
...
save_plot("~/sciebo/RecombinationLandscape_CRIP/01_Revison/NewResults/Plots/DecayPlots_run12_centromeres_100kb_chr3.1_all_less500bp_20241003.png", c3.1_n, base_asp = 1.9, dpi = 500, bg = "white")
save_plot("~/sciebo/RecombinationLandscape_CRIP/01_Revison/NewResults/Plots/DecayPlots_run12_centromeres_100kb_chr3.1_all_less500bp_20241003.svg", c3.1_n, base_asp = 1.9, dpi = 500, bg = "white")
