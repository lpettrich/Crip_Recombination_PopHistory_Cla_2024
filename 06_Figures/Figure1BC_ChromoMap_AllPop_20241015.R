...
files_to_read = list.files(
  path = "~/sciebo/RecombinationLandscape_CRIP/01_Revison/Sorted_final_files/Final_Supplement/Zenodo/MELT-run2/Cla1/AllPop/2-GroupAnalysis",        # directory to search within
