...
save_plot("~/sciebo/RecombinationLandscape_CRIP/01_Revison/NewResults/Plots/DecayPlots_run12_arms_100kb_SI_uniqueins.png", p_merged, nrow = 5, ncol = 1, base_asp = 1.9, dpi = 500, bg = "white")
save_plot("~/sciebo/RecombinationLandscape_CRIP/01_Revison/NewResults/Plots/DecayPlots_run12_arms_100kb_SI_uniqueins.svg", p_merged, nrow = 5, ncol = 1, base_asp = 1.9, dpi = 500, bg = "white")



c4<- c4 + scale_y_continuous(n.breaks = 5, limits=c(0, 150)) + labs(title = "Chromosome 4")
save_plot("~/sciebo/RecombinationLandscape_CRIP/01_Revison/NewResults/Plots/DecayPlots_run12_arms_100kb_SI_chr4_uniqueins.png", c4, base_asp = 1.9, dpi = 500, bg = "white")
save_plot("~/sciebo/RecombinationLandscape_CRIP/01_Revison/NewResults/Plots/DecayPlots_run12_arms_100kb_SI_chr4_uniqueins.svg", c4, base_asp = 1.9, dpi = 500, bg = "white")
