...
#---------------------------
# Read in inserts
inserts <- read.csv("~/sciebo/RecombinationLandscape_CRIP/01_Revison/NewResults/bedtools-closest/run12/MELT_uniqueins.csv", sep = ",", header = TRUE)
head(inserts)
...
dfm <- inner_join(dfm, inserts, by = c("no_insert", "pop"))
...
save_plot("~/sciebo/RecombinationLandscape_CRIP/01_Revison/NewResults/Plots/DecayPlots_run12_arms_100kb_MF_uniqueins.png", p_merged, nrow = 5, ncol = 1, base_asp = 1.9, dpi = 500, bg = "white")
save_plot("~/sciebo/RecombinationLandscape_CRIP/01_Revison/NewResults/Plots/DecayPlots_run12_arms_100kb_MF_uniqueins.svg", p_merged, nrow = 5, ncol = 1, base_asp = 1.9, dpi = 500, bg = "white")



c4<- c4 + scale_y_continuous(n.breaks = 5, limits=c(0, 80)) + labs(title = "Chromosome 4")
save_plot("~/sciebo/RecombinationLandscape_CRIP/01_Revison/NewResults/Plots/DecayPlots_run12_arms_100kb_MF_chr4_uniqueins.png", c4, base_asp = 1.9, dpi = 500, bg = "white")
save_plot("~/sciebo/RecombinationLandscape_CRIP/01_Revison/NewResults/Plots/DecayPlots_run12_arms_100kb_MF_chr4_uniqueins.svg", c4, base_asp = 1.9, dpi = 500, bg = "white")
