...
save_plot("/home/alle/sciebo/RecombinationLandscape_CRIP/Plots/png-files/MSMC2-climate-maps-CRIP-Years-combined_Manuscript_20230911.svg", 
          all_plots, nrow = 7, ncol = 4, base_asp = 1.7, dpi = 500, bg = "white", scale = 0.57)

save_plot("/home/alle/sciebo/RecombinationLandscape_CRIP/Plots/png-files/MSMC2-climate-maps-CRIP-Years-combined_Manuscript_20230911.png", 
          all_plots, nrow = 7, ncol = 4, base_asp = 1.7, dpi = 500, bg = "white", scale = 0.57)

# SAVE SEPERATE AND MERGE WITH INKSCAPE
pcol
save_plot("/home/alle/sciebo/RecombinationLandscape_CRIP/Plots/png-files/MSMC2-CRIP-Years_Manuscript_20230911.svg", 
          pcol, nrow = 3, ncol = 2, base_asp = 1.7, dpi = 500, bg = "white", scale = 0.8)



bottom_row
save_plot("/home/alle/sciebo/RecombinationLandscape_CRIP/Plots/png-files/Cimate-Maps_Manuscript_20230911.svg", 
