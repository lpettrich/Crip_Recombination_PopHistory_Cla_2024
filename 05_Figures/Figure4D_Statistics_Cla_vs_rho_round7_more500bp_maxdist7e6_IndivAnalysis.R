...
# Plot as heatmap
# Add empty dataframes as NA
results_df

Dataframe <- c("NMF_Chr4")
Correlation <- NA
pvalue <- NA
Significance <- NA
corrNA <- as.data.frame(cbind(Dataframe, Correlation, pvalue, Significance))
str(corrNA)
...
library(cowplot)
save_plot("../../../Plots/png-files/heatmap7e6_round7_more500bp.png", p, nrow = 1, ncol = 2, base_asp = 3.8, dpi = 500, bg = "white")

save_plot("../../../Plots/svg-files/heatmap7e6_round7_more500bp.svg", p, nrow = 1, ncol = 2, base_asp = 3.8, dpi = 500, bg = "white")
