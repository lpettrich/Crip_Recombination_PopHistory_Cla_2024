...
# common_path = "C:/Users/laupe/Documents/sciebo/RecombinationLandscape_CRIP/Scripts/01_Cla-annotation_IndivAnalysis/run07_Indiv/01_more500bp/"
common_path = "~/sciebo/RecombinationLandscape_CRIP/Scripts/01_Cla-annotation_IndivAnalysis/run07_Indiv/01_more500bp/"
...
save_plot("../../../Plots/DecayPlots_round7_more500bp.png", p_merged, nrow = 2, ncol = 2, base_asp = 1.9, dpi = 500, bg = "white")
save_plot("../../../Plots/DecayPlots_round7_more500bp.svg", p_merged, nrow = 2, ncol = 2, base_asp = 1.9, dpi = 500, bg = "white")
...
save_plot("../../../Plots/DecayPlots_round7_more500bp_max7e6_CHR1.png", c1_save, scale = 1.5, nrow = 1, ncol = 1, base_asp = 1.6, dpi = 500, bg = "white")
save_plot("../../../Plots/DecayPlots_round7_more500bp_max7e6_CHR1.svg", c1_save, scale = 1.5, nrow = 1, ncol = 1, base_asp = 1.6, bg = "white")
