...
#SBATCH --job-name=RepOBserver_run01
...
# Set directory
DIR=/projects/ag-waldvogel/pophistory/CRIP/centromeres/run01

cd ${DIR}

# Start RepeatOBserverV1
srun Setup_Run_Repeats.sh -i Criparius -f Chironomus_riparius_genome_010921.fasta -h H0 -c 15 -m 128000 -g FALSE
